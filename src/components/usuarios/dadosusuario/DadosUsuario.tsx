...
useEffect(() => {
    ...
    return (
        ...
        <div className="max-w-md mx-auto p-4 border-4 bg-indigo-300  rounded-2xl shadow-md">
    <h1 className="text-xl font-bold bg-indigo-600  mb-4">dados do usuário</h1>
    ...
    <div className="flex gap-2">
        ...
        <div className="flex gap-2">
        <Link to={`/editarcadastro/${usuario.id}`}
